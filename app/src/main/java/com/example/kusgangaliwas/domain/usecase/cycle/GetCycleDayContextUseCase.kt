...
/**
 * Builds lightweight cycle context for the day/session entry screen.
 */
class GetCycleDayContextUseCase @Inject constructor(
    ...
    suspend operator fun invoke(): CycleDayContext? {

        val cycle = trainingCycleRepository
            .getAnyActiveCycle()
            ?: return null
